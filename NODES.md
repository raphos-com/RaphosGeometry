...
| **Marching Cubes** | Extract an isosurface triangle mesh from a scalar field sampled on a regular grid. | Turning volumetric data into a surface — an organ isosurface from a CT/MRI scan, or an implicit/metaball shape into a printable mesh. |
